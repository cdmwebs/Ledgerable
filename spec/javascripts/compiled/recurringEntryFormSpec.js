(function() {
  describe("RecurringEntryFormView", function() {
    ...
    beforeEach(function() {
      ...
      this.app = window.app;
      this.date = $('#recurring_entry_start_date');
      this.payee = $('#recurring_entry_payee');
      this.memo = $('#recurring_entry_memo');
      this.amount = $('#recurring_entry_amount');
    ...
    describe("when used for a 'new' form", function() {
      beforeEach(function() {
        this.app.action = 'new';
        return $('form').attr('action', '/ledgers/1/recurring_entries');
      });
      ...
      return it("knows the how its element", function() {
        return expect(this.app.el).toEqual('form.new_recurring_entry');
      });
    });
    describe("when used for a 'edit' form", function() {
      beforeEach(function() {
        this.editApp = initRecurringentryForm('edit');
        return $('form').attr({
          "class": 'edit_recurring_entry',
          action: '/ledgers/1/recurring_entries/2'
        });
      });
      ...
      return it("knows the how its element", function() {
        return expect(this.editApp.el).toEqual('form.edit_recurring_entry');
      });
    });
